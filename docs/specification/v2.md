...
graph TD
    ...
    subgraph Page Processing
        ...
        D8 --> D9["Reconstruct Nodes Text+Spans w/ data-original-text"]; %% Simplified D9 %%
        ...
        subgraph User Actions ["Step 9"]
           ...
           G3["User Uses Context Menu Action"] --> G4["Apply Action to Current Page/Domain"]; %% Simplified G3 and G4 %%
        end
