...
**Objective** – Lay down the technical scaffold, development tooling, and a CI/CD
pipeline.
...
**Objective** – Prototype core text extraction and DOM augmentation on static pages
...
**Objective** – Connect the prototype to backend APIs, add authentication, fetch
...
**Objective** – Finish deferred features, add SPA & mutation handling, optimise
...
**Objective** – Finalise docs, assets, and compliance checks for Chrome Web Store
submission.
