...
graph TD
    ...
    subgraph Page Processing
        ...
        B4 --> B5;
        B3 -- No --> B5;
        B5["Identify Main Content Area(s)"] --> B6["Step 3: Extract Text Nodes (Viewport + Buffer)"]; %% Corrected Line 18 %%
        ...
        D13 --> D14["Step 8: Start Visibility Tracking for 'Seen' Analytics"]; %% Also added quotes here %%
        D14 --> D_NextRes;
        ...
        subgraph User Actions ["Step 9"]
           ...
           G3[User Uses Context Menu (Pause/Blacklist)] --> G4[Apply Action to Current Page/Domain];
        end
    ...
    %% Styling (Optional, helps readability)
